...
#deciding a valid move based on a given game state. This particualar file is in charge
#of creating optimal hazard and food placement.
#
#Variables:
...
class AIPlayer(Player):
    ...
    def __init__(self, inputPlayerId):
        super(AIPlayer,self).__init__(inputPlayerId, "gene2")
        self.popSize = 20
        self.population = []
        self.nextGen = []
        self.fitnessList = []
    ...
    def registerWin(self, hasWon):
        ...
        if(hasWon):
            self.geneScore = self.geneScore+1
