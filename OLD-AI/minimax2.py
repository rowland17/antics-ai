...
class AIPlayer(Player):
    ...
    def __init__(self, inputPlayerId):
        ...
        super(AIPlayer,self).__init__(inputPlayerId, "MiniMaximus2")
    ...
    #   and returns the min or max node depending on whose turn it is
    #
    # Parameters:
    ...
    def exploreTree(self, currentNode, currentDepth):
        ...
        nodesToIterate = heapq.nlargest(SUBSET_POOL, possibleNodes, key=lambda x: x["state_value"])
